...
class RegisterPage(tk.Frame):
	...
	def __init__(self, parent, Game):
		...
		self.btn_save_register = tk.Button(self.main_frame, text="Save", font=("Monaco", 22, "bold"), command=lambda:self.game.clicked_save_register_btn())
		self.btn_save_register.pack(pady=10)

		self.btn_cancel_register = tk.Button(self.main_frame, text="Cancel", font=("Monaco", 22, "bold"), command=lambda:self.game.create_loginPage())
